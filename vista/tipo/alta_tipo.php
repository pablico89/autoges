...
<html lang="es">
  ...
  <body>
	...
	<div class="page-header">
	  <h1>Alta Tipo de Cliente</h1>
	</div>
		<form class="form-horizontal" role="form" action="autoventa.php" method="POST">
			<input type="hidden" name="accion" value="guarda_tipo">
			...
			<div align="center">
				<button type="submit" class="btn btn-block btn-success"><span class="glyphicon glyphicon-arrow-tick"></span> Guardar Tipo</button>
			</div>
		</form>
		<br>
