  ...
  <body>
	...
	?>
		...
		<form class="form-horizontal" role="form" action="autoventa.php" method="POST">
			<input type="hidden" name="accion" value="modifica_tipo">
			<input type="hidden" name="id_tipo" value="<?php echo $datos_tipo['id_tipo']?>">
			<div class="page-header">
			  <h1>Consulta de Tipos <small>Id: <?php echo $datos_tipo['id_tipo']?></small></h1>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input class="form-control" value="<?php echo $datos_tipo['id_tipo']?>" placeholder="Introduzca ID" disabled>
				</div>
			</div>		
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">Nombre</label>
				<div class="col-sm-6">
					<input class="form-control" id="nombre" name="nombre" value="<?php echo $datos_tipo['nombre']?>" placeholder="Introduzca nombre">
				</div>
			</div>
		...
		<br>
				<div align="right"><a href="autoventa.php?accion=baja_tabla&id=<?php echo $datos_tipo['id_tipo']?>&tabla=tipo" class="btn btn-danger"><span class="glyphicon glyphicon-arrow-left"></span> Eliminar</a></div>
		<br>
		<a href="autoventa.php?accion=lista_tipo" class="btn btn-block btn-primary"><span class="glyphicon glyphicon-arrow-left"></span> Volver</a>
