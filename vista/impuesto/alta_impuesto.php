...
<html lang="es">
  ...
  <body>
	...
	<div class="page-header">
	  <h1>Alta de impuesto</h1>
	</div>
		<form class="form-horizontal" role="form" action="autoventa.php" method="POST">
			<input type="hidden" name="accion" value="guarda_impuesto">
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">Nombre</label>
				<div class="col-sm-6">
					<input class="form-control" type="text" id="nombre" name="nombre" placeholder="Introduzca nombre">
				</div>
			</div>
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">% Iva</label>
				<div class="col-sm-6">
					<input class="form-control" type="number" step="any" id="iva" name="iva" placeholder="Introduzca el iva">
				</div>
			</div>
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">% Recargo</label>
				<div class="col-sm-6">
					<input class="form-control" type="number" step="any" id="recargo" name="recargo" placeholder="Introduzca el recargo">
				</div>
			</div>	
		
			  <div align="center">
				<button type="submit" class="btn btn-block btn-success"><span class="glyphicon glyphicon-arrow-tick"></span> Guardar impuesto</button>
			  </div>
		</form>
		<br>
