  ...
  <body>
	...
	?>
		...
		<form class="form-horizontal" role="form" action="autoventa.php" method="POST">
			<input type="hidden" name="accion" value="modifica_impuesto">
			<input type="hidden" name="id_impuesto" value="<?php echo $datos_impuesto['id_impuesto']?>">
			<div class="page-header">
			  <h1>Consulta de impuesto <small>Id: <?php echo $datos_impuesto['id_impuesto']?></small></h1>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input class="form-control" value="<?php echo $datos_impuesto['id_impuesto']?>" placeholder="Introduzca ID" disabled>
				</div>
			</div>		
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">Nombre</label>
				<div class="col-sm-6">
					<input class="form-control" id="nombre" name="nombre" value="<?php echo $datos_impuesto['nombre']?>" placeholder="Introduzca nombre">
				</div>
			</div>
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">% Iva</label>
				<div class="col-sm-6">
					<input class="form-control" type="number" step="any" id="iva" name="iva" value="<?php echo $datos_impuesto['iva']?>" placeholder="Introduzca iva">
				</div>
			</div>
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">% Recargo</label>
				<div class="col-sm-6">
					<input class="form-control" type="number" step="any" id="recargo" name="recargo" value="<?php echo $datos_impuesto['recargo']?>" placeholder="Introduzca iva">
				</div>
			</div>
			  <div align="center">
		...
		<br>
				<div align="right"><a href="autoventa.php?accion=baja_tabla&id=<?php echo $datos_impuesto['id_impuesto']?>&tabla=impuesto" class="btn btn-danger"><span class="glyphicon glyphicon-arrow-left"></span> Eliminar</a></div>
		<br>
		<a href="autoventa.php?accion=lista_impuesto" class="btn btn-block btn-primary"><span class="glyphicon glyphicon-arrow-left"></span> Volver</a>
