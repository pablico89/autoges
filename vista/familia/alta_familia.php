	...
	<div class="page-header">
	  <h1>Alta de familia</h1>
		...
		<form class="form-horizontal" role="form" action="autoventa.php" method="POST">
			<input type="hidden" name="accion" value="guarda_familia">
			<div class="form-group">
			  ...
			  <div align="center">
				<button type="submit" class="btn btn-block btn-success"><span class="glyphicon glyphicon-arrow-tick"></span> Guardar familia</button>
			  </div>
		</form>
		<br>
