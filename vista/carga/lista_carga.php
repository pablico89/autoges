...
<html lang="es">
  ...
  <body>
	...
	<div class="page-header">
	  <h1>Lista de cargas <small></small></h1>
	</div>
	<form action="#" method="get">
				 ...
				 <table class="table table-list-search table-striped table-bordered">
							...
							<tbody>
							 <?php $contador = 0; foreach ($lista_carga as $dato): $contador++;?>
										<tr>

										<td><?php echo $dato['id_carga']; ?></td>
										<td><?php echo $dato['fecha']; ?></td>
										<td><?php 
										if($dato['id_almacen_origen'] == "00")
											echo "General - ".$dato['id_almacen_destino']; 
										else
											echo $dato['id_almacen_origen']." - ".$dato['id_almacen_destino']; 
											
											?></td>
										<td><?php echo $dato['total_cajas']; ?></td>
										<td><?php echo $dato['total_unidades']; ?></td>
										<td><a href="autoventa.php?accion=imprime_carga&id_carga=<?php echo $dato['id_carga']?>" class="btn btn-default"><span class="glyphicon glyphicon-list-alt"></span> Imprimir</a></td>
										</tr>
										<?php endforeach; ?>
