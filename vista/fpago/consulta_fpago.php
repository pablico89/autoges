  ...
  <body>
	...
	?>
		...
		<form class="form-horizontal" role="form" action="autoventa.php" method="POST">
			<input type="hidden" name="accion" value="modifica_fpago">
			<input type="hidden" name="id_fpago" value="<?php echo $datos_fpago['id_fpago']?>">
			<div class="page-header">
			  <h1>Consulta de Forma de pago <small>Id: <?php echo $datos_fpago['id_fpago']?></small></h1>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input class="form-control" value="<?php echo $datos_fpago['id_fpago']?>" placeholder="Introduzca ID" disabled>
				</div>
			</div>		
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">Nombre</label>
				<div class="col-sm-6">
					<input class="form-control" id="nombre" name="nombre" value="<?php echo $datos_fpago['nombre']?>" placeholder="Introduzca nombre">
				</div>
			</div>
		...
		<br>
				<div align="right"><a href="autoventa.php?accion=baja_tabla&id=<?php echo $datos_fpago['id_fpago']?>&tabla=fpago" class="btn btn-danger"><span class="glyphicon glyphicon-arrow-left"></span> Eliminar</a></div>
		<br>
		<a href="autoventa.php?accion=lista_fpago" class="btn btn-block btn-primary"><span class="glyphicon glyphicon-arrow-left"></span> Volver</a>
