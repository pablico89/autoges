...
<html lang="es">
  ...
  <body>
	...
	<div class="page-header">
	  <h1>Lista de saldos pendientes <small></small></h1>
	</div>
	<form action="#" method="get">
				 ...
				 <table class="table table-list-search table-striped table-bordered">
							...
							<tbody>
							 <?php $contador = 0; foreach ($lista_saldo as $dato): $contador++;?>
										<tr>

										<td><?php echo $dato['id_venta']; ?></td>
										<td><?php echo $dato['id_cliente']." ".$dato['nombre']; ?></td>
										<td><?php echo $dato['importe']; ?></td>
										<td><?php if($dato['importe']>0) echo '<a href="autoventa.php?accion=alta_cobro&miga=pendiente&id_venta='.$dato['id_venta'].'" class="btn btn-default"><span class="glyphicon glyphicon-euro"></span> Cobro</a>'?></td>
										</tr>
										<?php endforeach; ?>
