...
<html lang="es">
  ...
  <body>
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	  <div class="modal-dialog">
		<div class="modal-content">
		  ...
		  <input type="hidden" name="accion" value="alta_ruta">
						...
						<table class="table table-list-search">
							...
							<tbody>
							 <?php $contador = 0; foreach ($lista_cliente as $dato): $contador++;?>
										...
										<td><input type="checkbox" name="clientes[]" value="<?php echo $dato['codcliente']?>" <?php if(in_array($dato['codcliente'], $seleccionados)){echo "checked";}?>></td>
										</tr>
										<?php endforeach; ?> 
	...
	<div class="page-header">
	  <h1>Nueva ruta <small></small></h1>
	</div>
	<form class="form-horizontal" id="1" action="autoventa.php" method="POST" role="form">
	<input type="hidden" name="accion" value="guarda_ruta">
	  <div class="form-group">
		<label for="inputEmail3" class="col-sm-2 control-label">Nombre de la ruta</label>
		<div class="col-sm-10">
		  <input type="text" class="form-control" id="nombre_ruta" name="nombre_ruta" placeholder="Introduce el nombre">
		</div>
	  </div>
	<hr>
	<hr>
	<div class="form-group">
		...
		<div class="col-sm-10">
			<ul class="list-group">
				<?php foreach($seleccionados as $dato):?>
			  <li class="list-group-item"><?php echo $lista_cliente[$dato]['nombre']?></li>
				<?php endforeach;?>
			</ul>
		</div>
	  </div>
